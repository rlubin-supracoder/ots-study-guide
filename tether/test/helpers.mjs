...
export const migrations=[{version:1,sql:migration},{version:2,sql:readFileSync(new URL('../migrations/002_member_sessions.sql',import.meta.url),'utf8')}];
...
export function fixture(filename) {
  ...
  const db=new Database(s,migrations,'staff@example.test',()=>time);
